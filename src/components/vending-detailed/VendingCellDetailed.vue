<template>
  <div class="vending-cell-detailed" :class="{ 'cell-empty': cell.bottles.length === 0 }">
    <SpiralCoilDetailed :is-rotating="isSpiralRotating" />
    <div v-if="cell.bottles.length > 0" class="cell-bottles">
      ...
      >
        <BottleSpriteDetailed :size="bottle.size" :ml="bottle.ml" :drink-type="bottle.drinkType ?? 'water'" />
      </div>
    </div>
...
import SpiralCoilDetailed from './SpiralCoilDetailed.vue'
