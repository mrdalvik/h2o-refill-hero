export default {
  ...
  onboarding: {
    text: 'नमस्ते! यह मशीन आपको पानी पीना याद दिलाती है। जब पिएं — दाएं नंबर पैनल पर टैप करें और पानी जोड़ें। दिन के अंत में ग्राहक इसे ले जाएंगे और सब फिर से शुरू। अनुस्मारक चालू करने के लिए सेटिंग्स देखें।',
    gotIt: 'समझ गया',
  },
  devSettings: {
