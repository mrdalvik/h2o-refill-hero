export default {
  ...
  onboarding: {
    text: 'Привет! Этот автомат поможет тебе не забыть попить. Когда попьёшь — нажми на панель с цифрами справа и добавь воду. В конце дня её заберут покупатели, и всё начнётся заново. Загляни в настройки, чтобы включить напоминания и точно не забыть попить.',
    gotIt: 'Понятно',
  },
  devSettings: {
