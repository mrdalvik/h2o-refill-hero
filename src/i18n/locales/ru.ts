export default {
  ...
  onboarding: {
    step1: 'Привет! Этот автомат поможет тебе не забыть попить воды.',
    step2: 'Нажми на панель справа, введи объём в мл и нажми «Поставить на полку» — вода добавится.',
    step3: 'В настройках можно включить напоминания, цель и другие опции.',
    next: 'Далее',
    gotIt: 'Понятно',
  },
  devSettings: {
